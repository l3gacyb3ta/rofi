...
<p align="center">
  <img src="https://raw.githubusercontent.com/l3gacyb3ta/rofi/assets/screenshot.png"/>
</p>

## Usage

1. Clone this repository locally
2. Copy `catppuccin.rasi` to `~/.config/rofi/`
3. Run rofi with `-theme catppuccin`
4. Or, add `@theme "catppuccin` to your `~/.config/rofi/config.rofi`

## 💝 Thanks to

- [Arch Wiki (amazing docs, and invaluble in doing this.)](https://wiki.archlinux.org/title/Rofi)
